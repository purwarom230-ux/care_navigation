...
.cn-auth-overlay{position:fixed;inset:0;z-index:100;display:flex;align-items:center;justify-content:center;background:rgba(29,42,45,0.96);backdrop-filter:blur(4px);padding:1rem}
...
.cn-field input:focus{border-color:var(--cn-primary,#337a5b)}
...
.cn-btn-primary{background:var(--cn-primary,#337a5b);color:var(--cn-primary-text,#fff)}
...
.cn-auth-switch button{background:none;border:none;color:var(--cn-primary,#337a5b);font-weight:600;cursor:pointer;font-size:.82rem}
.cn-mode-badge{display:inline-block;font-size:.65rem;font-weight:700;letter-spacing:.08em;text-transform:uppercase;padding:.15rem .5rem;border-radius:999px;background:var(--cn-secondary,#e6f2f0);color:var(--cn-primary,#337a5b);margin-bottom:.75rem}
...
.cn-signin-btn{display:inline-flex;align-items:center;gap:.45rem;padding:.5rem .95rem;font-size:.85rem;font-weight:600;border-radius:.75rem;background:var(--cn-secondary,#e6f2f0);color:var(--cn-primary,#337a5b);border:none;cursor:pointer;transition:filter .15s}
.cn-signin-btn:hover{filter:brightness(.97)}
.cn-avatar{width:1.75rem;height:1.75rem;border-radius:999px;background:var(--cn-primary,#337a5b);color:var(--cn-primary-text,#fff);display:inline-flex;align-items:center;justify-content:center;font-size:.75rem;font-weight:700}
...
.cn-panel-list li span:last-child{font-weight:600;text-align:right}
  ...
  function announce(msg) {
    var t = h("div", { role: "status", style: "position:fixed;bottom:1rem;left:50%;transform:translateX(-50%);z-index:200;background:var(--cn-primary,#337a5b);color:#fff;padding:.6rem 1.1rem;border-radius:999px;font-size:.85rem;box-shadow:0 10px 30px rgba(0,0,0,.25)" });
